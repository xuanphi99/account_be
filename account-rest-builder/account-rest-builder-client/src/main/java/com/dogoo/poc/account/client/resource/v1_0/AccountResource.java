package com.dogoo.poc.account.client.resource.v1_0;
...
import com.dogoo.poc.account.client.problem.Problem;
...
public interface AccountResource {
	...
	public Account getDetail(Long accountId) throws Exception;

	public HttpInvoker.HttpResponse getDetailHttpResponse(Long accountId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse addAccountHttpResponse(Account account)
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public HttpInvoker.HttpResponse deleteAccountHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/account-rest-builder/v1.0/accounts/{accountId}");
		...
		public HttpInvoker.HttpResponse deleteAccountBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/account-rest-builder/v1.0/accounts/batch");
		...
		public Account getDetail(Long accountId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getDetailHttpResponse(
				accountId);
		...
		public HttpInvoker.HttpResponse getAllAccountHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/account-rest-builder/v1.0/accounts");
		...
		public Account addAccount(Account account) throws Exception {
			HttpInvoker.HttpResponse httpResponse = addAccountHttpResponse(
				account);
