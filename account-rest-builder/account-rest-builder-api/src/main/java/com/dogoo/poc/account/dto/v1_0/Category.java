 ...
 */
@Generated("")
@GraphQLName(description = "A very simple category", value = "Category")
...
public class Category implements Serializable {
	...
	@Schema(description = "Name Type of category")
	...
	@GraphQLField(description = "Name Type of category")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "type category")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		...
		defaultValue = "com.dogoo.poc.account.dto.v1_0.Category",
		name = "x-class-name"
	)
