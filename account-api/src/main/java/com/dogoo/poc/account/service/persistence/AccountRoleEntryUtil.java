...
public class AccountRoleEntryUtil {
	...
	public static AccountRoleEntry findByUuid_First(
		...
		throws com.dogoo.poc.account.exception.NoSuchAccountRoleEntryException {
