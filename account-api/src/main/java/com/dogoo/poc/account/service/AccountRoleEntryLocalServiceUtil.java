 ...
 * <code>com.dogoo.poc.account.service.impl.AccountRoleEntryLocalServiceImpl</code> and
...
public class AccountRoleEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.dogoo.poc.account.service.impl.AccountRoleEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void addRoles(
		...
		getService().addRoles(accountEntry, roleIds);
	}
	...
	public static List<AccountRoleEntry> findAllByAccountId(long accountId) {
		return getService().findAllByAccountId(accountId);
	}
