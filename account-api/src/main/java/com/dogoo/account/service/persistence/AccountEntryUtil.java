...
public class AccountEntryUtil {
	...
	public static AccountEntry findByUuid_First(
		...
		throws com.dogoo.account.exception.NoSuchAccountEntryException {
	 ...
	 * @throws NoSuchAccountEntryException if a matching account entry could not be found
	 */
	public static AccountEntry findByUserName(String newUser)
		throws com.dogoo.account.exception.NoSuchAccountEntryException {

		return getPersistence().findByUserName(newUser);
	}
	 ...
	 * @return the matching account entry, or <code>null</code> if a matching account entry could not be found
	 */
	public static AccountEntry fetchByUserName(String newUser) {
		return getPersistence().fetchByUserName(newUser);
	}
	...
	public static AccountEntry fetchByUserName(
		...
		return getPersistence().fetchByUserName(newUser, useFinderCache);
	}
	 ...
	 * @return the account entry that was removed
	 */
	public static AccountEntry removeByUserName(String newUser)
		throws com.dogoo.account.exception.NoSuchAccountEntryException {

		return getPersistence().removeByUserName(newUser);
	}
	 ...
	 * @return the number of matching account entries
	 */
	public static int countByUserName(String newUser) {
		return getPersistence().countByUserName(newUser);
	}
