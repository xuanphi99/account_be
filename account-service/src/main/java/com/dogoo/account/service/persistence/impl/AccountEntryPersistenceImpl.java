...
package com.dogoo.account.service.persistence.impl;

import com.dogoo.account.exception.NoSuchAccountEntryException;
import com.dogoo.account.model.AccountEntry;
import com.dogoo.account.model.AccountEntryTable;
import com.dogoo.account.model.impl.AccountEntryImpl;
import com.dogoo.account.model.impl.AccountEntryModelImpl;
import com.dogoo.account.service.persistence.AccountEntryPersistence;
import com.dogoo.account.service.persistence.impl.constants.DGPersistenceConstants;
...
public class AccountEntryPersistenceImpl
	...
	public AccountEntry findByUserName(String newUser)
		...
		AccountEntry accountEntry = fetchByUserName(newUser);
	...
	public AccountEntry fetchByUserName(String newUser) {
		return fetchByUserName(newUser, true);
	}
	...
	public AccountEntry fetchByUserName(
		String newUser, boolean useFinderCache) {

		newUser = Objects.toString(newUser, "");

		Object[] finderArgs = null;

		if (useFinderCache) {
			finderArgs = new Object[] {newUser};
		}
		...
		if (result instanceof AccountEntry) {
			...
			if (!Objects.equals(newUser, accountEntry.getNewUser())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			boolean bindNewUser = false;

			if (newUser.isEmpty()) {
				sb.append(_FINDER_COLUMN_USERNAME_NEWUSER_3);
			}
			else {
				bindNewUser = true;

				sb.append(_FINDER_COLUMN_USERNAME_NEWUSER_2);
			}
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccountEntryPersistenceImpl.fetchByUserName(String, boolean) with parameters (" +
	...
	public AccountEntry removeByUserName(String newUser)
		...
		AccountEntry accountEntry = findByUserName(newUser);
	...
	public int countByUserName(String newUser) {
		...
		Object[] finderArgs = new Object[] {newUser};
	...
	private static final String _FINDER_COLUMN_USERNAME_NEWUSER_2 =
		"accountEntry.newUser = ?";

	private static final String _FINDER_COLUMN_USERNAME_NEWUSER_3 =
		"(accountEntry.newUser IS NULL OR accountEntry.newUser = '')";
	...
	public void cacheResult(AccountEntry accountEntry) {
		...
		finderCache.putResult(
			...
			new Object[] {accountEntry.getNewUser()}, accountEntry);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {accountEntryModelImpl.getNewUser()};

		finderCache.putResult(
			_finderPathCountByUserName, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUserName, args, accountEntryModelImpl);
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByUserName = new FinderPath(
			...
			new String[] {String.class.getName()}, new String[] {"newUser"},
			true);
