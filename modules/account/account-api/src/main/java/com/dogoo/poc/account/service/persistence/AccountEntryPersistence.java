...
public interface AccountEntryPersistence extends BasePersistence<AccountEntry> {
	 ...
	 */
	public java.util.List<AccountEntry> getCategoryEntryAccountEntries(long pk);
	 ...
	 */
	public java.util.List<AccountEntry> getCategoryEntryAccountEntries(
	 ...
	 * @param categoryEntry the category entry
	 */
	public void removeCategoryEntry(
		long pk, com.dogoo.poc.account.model.CategoryEntry categoryEntry);
