...
/**
 * Provides the local service interface for CategoryEntry. Methods of this
...
public interface CategoryEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.dogoo.poc.account.service.impl.CategoryEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the category entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CategoryEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
